...
import mobile.shoppingcart.AddStore
...
class StoreAdapter (productList: List<Store>, internal var context: Context) : RecyclerView.Adapter<StoreAdapter.ViewHolder>() {

    internal var productList: List<Store> = ArrayList()
    init {
        this.productList = productList
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.list_store, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val i = Intent(context, AddStore::class.java)
            i.putExtra("Mode", "E")
